...
include('../fnc/fnc_facturasproveedores.php');
?>

<div id="Buscador" class="buscadorStl">
    <input type="text" id="txtBuscarFacturaproveedor" class="campoBuscador" onkeyup="searchFacturaproveedores(this.value);" />
...
<div id="TituloCategoria" class="separadorContenido">
    <span>FACTURAS PROVEEDORES</span>
